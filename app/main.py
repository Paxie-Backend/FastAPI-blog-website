...
from app.api.routers import v1_posts, v1_users
...
app.include_router(v1_users.router, prefix="/api/users", tags=["users"])
app.include_router(v1_posts.router, prefix="/api/posts", tags=["posts"])
